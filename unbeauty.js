...
document.querySelector('#iframe-no-display').top = "20px";
...
$(document).ready(function() {
	...
	$('li#navItem1').on("click", function() {
		$('html,body').animate({scrollTop: $("div#months2016").offset().top - 60}, 'slow');
		$('div#months2016').css('display', 'none').slideDown(1000);
	});

	$('li#navItem2').on("click", function() {
		$('html,body').animate({scrollTop: $("div#months2015").offset().top - 60}, 'slow');
		$('div#months2015').css('display', 'none').slideDown(1000);
	});

	$('li#navItem3').on("click", function() {
		$('html,body').animate({scrollTop: $("div#months2014").offset().top - 60}, 'slow');
...
$('div#months2016 p').on("click", function() {
	$('html,body').animate({
  	scrollTop: $("div#audio-container2016").offset().top - 50}, 'slow');
...
$('div#months2015 p').on("click", function() {
	$('html,body').animate({
  	scrollTop: $("div#audio-container2015").offset().top - 50}, 'slow');
...
$('div#months2014 p').on("click", function() {
	$('html,body').animate({
  	scrollTop: $("div#audio-container2014").offset().top - 50}, 'slow');
